...
<div className={className} style={{ position: 'relative' }}>
    <div style={{ borderTop: '20px solid #0054e9', position: 'absolute', top: 0, left: 0, width: '101%', zIndex: -1 }} />
...
const StyledHeaderButtons = styled(HeaderButtons)`
opacity: 1;
height: 22px;
display: flex;
align-items: center;
...
export default StyledHeaderButtons;
